...
const MissionSection = () => {
  ...
  return (
    <section className="bg-background-primary py-24 sm:py-32" style={{ backgroundImage: `url('https://hackmd.io/_uploads/B1Lp3VB6gl.jpg')`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundAttachment: 'fixed', backgroundRepeat: 'no-repeat' }}>
