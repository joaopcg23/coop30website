...
const VisionSection = () => {
  return (
    <section className="bg-background-primary py-12 mt-16" style={{ backgroundImage: `url('https://hackmd.io/_uploads/B1Lp3VB6gl.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
